...

      {
        isOpen ? 
          ...
          <motion.div
            ...
            className='min-w-[70vw] flex flex-col z-30 flex justify-center items-center fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2  bg-dark/90 dark:bg-light/75 rounded-lg backdrop-blur-md  py-32'>
