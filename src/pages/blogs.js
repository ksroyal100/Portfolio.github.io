...
const Blogs = ({title, date, link}) => {
    return (
        <motion.li
            ...
            viewport={{once: true}}
            className='relative w-full p-4 py-4 my-4 rounded-xl flex items-center justify-between bg-light text-dark first-mt-0 border border-solid border-dark'>
      ...
      <>
          ...
          <main className='w-full flex flex-col items-center justify-center overflow-hidden'>
              <Layout className='pt-16'>
                  <AnimatedText text='Words Can Change The World!' className='mb-16 text-[3rem]'/>
...
Build A Fabulous Todo List App With React, Redux And Framer-Motion'
                  ...
                  <h2 className='font-bold text-4xl w-full text-center my-32 '>All Blogs</h2>
                  <ul>
                      <Blogs 
