...
const Blogs = ({title, date, link}) => {
    return (
        <motion.li
            ...
            viewport={{once: true}}
            className='relative w-full p-4 py-4 my-4 rounded-xl flex items-center justify-between bg-light text-dark first-mt-0 border border-solid border-dark  dark:bg-dark dark:border-light dark:text-light'>
