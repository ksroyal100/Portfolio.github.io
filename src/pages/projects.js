        ...
        <article className='relative w-full flex items-center justify-between rounded-3xl border border-solid border-dark bg-light shadow-2xl p-12 rounded-br-2xl'>
            ...
            <div className='w-1/2 flex flex-col items-start justify-between pl-6'>
                ...
                <div className='mt-2 flex items-center'>
                    ...
                    <Link href={link} target="_blank"
                        className='ml-4 rounded-lg bg-dark/85 text-light p-2 px-6 text-lg font-semibold  hover:bg-white hover:text-black border-2 border-solid border-transparent hover:border-black'>
                        Visit project</Link>
                </div>
            </div>
...
const Project = ({title, type, img, link, github}) => {
    return (
        <article className='relatve w-full flex flex-col items-center justify-center rounded-2xl border border-solid border-dark bg-light p-4 relative'>
